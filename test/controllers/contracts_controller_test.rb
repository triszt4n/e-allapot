...
class ContractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract" do
    assert_difference('Contract.count') do
      post contracts_url, params: { contract: { room_id: @contract.room_id, user_id: @contract.user_id, year: @contract.year } }
    end
  ...
  test "should update contract" do
    patch contract_url(@contract), params: { contract: { room_id: @contract.room_id, user_id: @contract.user_id, year: @contract.year } }
